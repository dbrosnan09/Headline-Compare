...
"""
#to add backedup headlines, put in lists here, then in line 628 adjust tehe date accordingly

import datetime

from decimal import *
nytimeslist = [[1, 1, 'Minnesota Officer Who Shot Daunte Wright Meant to Fire Taser, Chief\xa0Says', 'https://www.nytimes.com/2021/04/12/us/brooklyn-center-police-shooting-minnesota.html', Decimal('0E-10'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [1, 2, 'Here’s what we know about the killing of Daunte Wright.', 'https://www.nytimes.com/article/daunte-wright-death-minnesota.html', Decimal('0E-10'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [1, 3, 'George Floyd’s Brother Takes the Stand; Minneapolis Is on Edge After Shooting', 'https://www.nytimes.com/live/2021/04/12/us/derek-chauvin-trial/', Decimal('0E-10'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [1, 4, 'Key moments from Day 11 of the trial: George Floyd’s death was “absolutely preventable,” a cardiologist testified.', 'https://www.nytimes.com/2021/04/12/us/derek-chauvin-trial-takeaways.html', Decimal('0.1000000000'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [1, 5, 'C.D.C. Director Says Michigan Should Shut Down to Slow\xa0Outbreak', 'https://www.nytimes.com/live/2021/04/12/world/covid-vaccine-coronavirus-cases/', Decimal('-0.2277777778'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [1, 6, 'After Enduring World’s Longest Restrictions, Britain Begins to Unlock', 'https://www.nytimes.com/live/2021/04/12/world/britain-lockdown-reopening-virus/', Decimal('0E-10'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [1, 7, 'Blaming Israel, Iran Vows Revenge for Blackout at Nuclear\xa0Site', 'https://www.nytimes.com/2021/04/12/world/middleeast/iran-israel-nuclear-site.html', Decimal('0E-10'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [1, 8, 'Talks to bring the U.S. and Iran back to compliance with the 2015 nuclear deal may have just grown harder.', 'https://www.nytimes.com/2021/04/05/world/europe/iran-nuclear-talks-explained.html', Decimal('-0.0500000000'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [1, 9, 'Biden’s Infrastructure Push Spurs a Flurry of Lobbying in\xa0Congress', 'https://www.nytimes.com/2021/04/11/us/politics/biden-infrastructure-congress.html', Decimal('0E-10'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [1, 10, 'Washington Updates', 'https://www.nytimes.com/live/2021/04/12/us/biden-news-today?type=styln-live-updates&label=washington updates&index=0', Decimal('0E-10'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [1, 11, 'Biden meets with a bipartisan group of lawmakers, saying he’s ‘prepared to negotiate’ on infrastructure.', 'https://www.nytimes.com/live/2021/04/12/us/biden-news-today?type=styln-live-updates&label=washington%20updates&index=0#biden-meets-with-a-bipartisan-group-of-lawmakers-saying-hes-prepared-to-negotiate-on-infrastructure', Decimal('0E-10'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [1, 12, 'Biden picks first woman to be Army secretary.', 'https://www.nytimes.com/live/2021/04/12/us/biden-news-today?type=styln-live-updates&label=washington%20updates&index=0#christine-wormuth-army-secretary', Decimal('0.2500000000'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [1, 13, 'Business Updates', 'https://www.nytimes.com/live/2021/04/12/business/stock-market-today?type=styln-live-updates&label=business updates&index=1', Decimal('0E-10'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [1, 14, 'The U.S. budget deficit hit a record $1.7 trillion in the first half of the fiscal year.', 'https://www.nytimes.com/live/2021/04/12/business/stock-market-today?type=styln-live-updates&label=business%20updates&index=1#united-states-budget-deficit', Decimal('0.0416666667'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [1, 15, 'Amid a chip shortage, the White House gathers business leaders to discuss supplies.', 'https://www.nytimes.com/live/2021/04/12/business/stock-market-today?type=styln-live-updates&label=business%20updates&index=1#semiconductor-chip-shortage', Decimal('0E-10'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [1, 16, 'Defying Republicans, Big Companies Keep the Focus on Voting\xa0Rights', 'https://www.nytimes.com/2021/04/12/business/corporate-leaders-voting-laws.html', Decimal('0E-10'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [1, 17, 'Will Smith’s film production is pulling out of Georgia, citing the state’s voting law.', 'https://www.nytimes.com/2021/04/12/business/will-smith-emancipation-georgia.html', Decimal('0E-10'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [1, 18, 'Scandal Erupts in Valdosta, Georgia’s Football\xa0‘Titletown’', 'https://www.nytimes.com/2021/04/12/sports/valdosta-georgia-football-propst.html', Decimal('0E-10'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [1, 19, 'A Push to Move the Golf Course Atop a Native American\xa0‘Stonehenge’', 'https://www.nytimes.com/2021/04/12/arts/design/octagon-earthworks-newark-ohio-golf-course-native-american.html', Decimal('0E-10'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [1, 20, 'My Family’s Global Vaccine\xa0Journey', 'https://www.nytimes.com/2021/04/11/health/coronavirus-vaccines-global-journey.html', Decimal('0E-10'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [1, 21, 'Matt Gaetz Is Both Unique and … Not So Unique', 'https://www.nytimes.com/2021/04/12/opinion/gaetz-sex-scandals.html', Decimal('0.3750000000'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [1, 22, 'The Grief Crisis Is Coming', 'https://www.nytimes.com/2021/04/12/opinion/covid-death-grief.html', Decimal('-0.8000000000'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [1, 23, 'A Public Health Lesson for Ron DeSantis, From Harvard', 'https://www.nytimes.com/2021/04/12/opinion/sway-kara-swisher-michelle-williams.html', Decimal('0E-10'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [1, 24, 'Tucker Carlson and White Replacement', 'https://www.nytimes.com/2021/04/11/opinion/tucker-carlson-white-replacement.html', Decimal('0E-10'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [1, 25, 'Can Biden Be Our F.D.R.?', 'https://www.nytimes.com/2021/04/12/opinion/biden-fdr-new-deal.html', Decimal('0E-10'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)]]
bbclist = [[2, 1, "Officer who shot black man 'meant to deploy Taser'", 'https://bbc.com/news/world-us-canada-56724798', Decimal('-0.1666666667'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [2, 2, 'New footage shows the shooting of Daunte Wright', 'https://bbc.com/news/world-us-canada-56726543', Decimal('0.1363636364'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [2, 3, "'I miss my brother, George Floyd'", 'https://bbc.com/news/live/world-us-canada-56721011', Decimal('0E-10'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [2, 4, "Royal brothers pay tribute to 'Grandpa' Philip", 'https://bbc.com/news/uk-56721559', Decimal('0E-10'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [2, 5, 'Will Smith film leaves Georgia over voting laws', 'https://bbc.com/news/entertainment-arts-56716449', Decimal('0E-10'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [2, 6, "'The first spaceman landed in my field'", 'https://bbc.com/news/science-environment-56690949', Decimal('0.2500000000'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [2, 7, 'The Friends reunion has been filmed in Los Angeles', 'https://bbc.com/news/entertainment-arts-56719418', Decimal('0E-10'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [2, 8, 'Iran ‘to avenge Israeli attack’ on nuclear site', 'https://bbc.com/news/world-middle-east-56715520', Decimal('0E-10'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [2, 9, 'France moves to ban short-haul domestic flights', 'https://bbc.com/news/world-europe-56716708', Decimal('0E-10'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [2, 10, "Manhunt after 'execution' shooting in Paris", 'https://bbc.com/news/world-europe-56724037', Decimal('0E-10'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [2, 11, "FBI arrest man 'who wanted to kill off internet'", 'https://bbc.com/news/technology-56719618', Decimal('-0.0500000000'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [2, 12, 'Drone footage shows huge fire in St Petersburg', 'https://bbc.com/news/world-europe-56722176', Decimal('0.4000000000'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [2, 13, "'World's biggest rabbit' stolen from garden", 'https://bbc.com/news/uk-england-hereford-worcester-56720118', Decimal('0E-10'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [2, 14, 'Neighbours star says cast mates wanted her deported', 'https://bbc.com/news/entertainment-arts-56716441', Decimal('0E-10'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [2, 15, "'I feel just as Indian as I feel black'", 'https://bbc.com/news/world-56597925', Decimal('-0.1666666667'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [2, 16, "'Floyd did not die from heart attack or overdose'", 'https://bbc.com/news/world-us-canada-56725647', Decimal('0E-10'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [2, 17, 'Could we bring back mammoths to fight climate change?', 'https://www.bbc.co.uk/ideas/videos/could-we-bring-back-mammoths-to-fight-climate-chan/p09cdh9z', Decimal('0E-10'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [2, 18, 'Anthony Hopkins on finding out Best Actor win', 'https://bbc.com/news/entertainment-arts-56713296', Decimal('0.9000000000'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [2, 19, "The tribes mourning their 'god' Prince Philip", 'https://bbc.com/news/world-asia-56713953', Decimal('0E-10'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [2, 20, 'Elephant calf rescued from bottom of well in India', 'https://bbc.com/news/world-south-asia-56709546', Decimal('0E-10'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [2, 21, "The 'Iron Man' body armour many of us may soon be wearing", 'https://bbc.com/news/business-56660644', Decimal('0.5000000000'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [2, 22, 'How Prince Harry can attend the funeral', 'https://bbc.com/news/uk-56709506', Decimal('0E-10'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [2, 23, 'Transatlantic struggle for painting stolen by Nazis', 'https://bbc.com/news/world-europe-56688032', Decimal('0E-10'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [2, 24, "Could Joe Biden's tax plan hit Ireland’s economy?", 'https://bbc.com/news/world-europe-56692865', Decimal('0E-10'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [2, 25, 'Ravaging Himalayan forest fires worry scientists', 'https://bbc.com/news/world-asia-india-56671148', Decimal('0E-10'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)]]
fnlist = [[3, 1, 'Minnesota bracing for another night of violence as officials announce curfew, deploy National Guard', 'https://www.foxnews.com/us/live-updates-daunte-wright-police-officer-shooting-national-guard-minneapolis-chauvin-floyd-trial', Decimal('0E-10'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [3, 2, 'Multiple people, including police officer, hurt in Tennessee shooting: authorities', 'https://www.foxnews.com/us/knoxville-high-school-shooting-leaves-multiple-people-hurt-including-cop-police-say', Decimal('0E-10'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [3, 3, 'Biden addresses deadly officer-involved shooting as police release graphic video', 'https://www.foxnews.com/politics/biden-urges-calm-daunte-wright-shooting-says-no-justification-for-looting-violence', Decimal('-0.1000000000'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [3, 4, 'Critics erupt after Fauci says vaccinated Americans still should not eat indoors', 'https://www.foxnews.com/media/fauci-dont-eat-indoors-even-after-getting-vaccine', Decimal('0E-10'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [3, 5, "CNN host widely mocked for inaccurate segment on Fox hosts, 'vaccine selfies'", 'https://www.foxnews.com/media/stelter-vaccine-selfies', Decimal('-0.1000000000'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [3, 6, "Scott Yenor explains how modern feminism compliments neoliberal institutions on 'Tucker Carlson Today'", 'https://video.foxnews.com/v/6248671124001/', Decimal('0.2000000000'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [3, 7, "Steve Hilton slams big business executives for pushing 'wokeism'", 'https://video.foxnews.com/v/6248466429001/', Decimal('0E-10'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [3, 8, "Levin: Biden is a 'chameleon' who doesn't have a 'principle bone in his body'", 'https://video.foxnews.com/v/6248460704001/', Decimal('0E-10'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [3, 9, 'Rep. Banks: Trump cemented relationship between working-class Americans and GOP party', 'https://video.foxnews.com/v/6248472460001/', Decimal('0E-10'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [3, 10, "Rep. Hinson: Democrats need to address the 'very important humanitarian crisis' at southern border", 'https://video.foxnews.com/v/6248433087001/', Decimal('0.2600000000'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [3, 11, "Biden, Democrats seek to redefine American 'infrastructure'", 'https://video.foxnews.com/v/6248472104001/', Decimal('0E-10'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [3, 12, 'Rep. Lee Zeldin is off and running for governor of New York State', 'https://video.foxnews.com/v/6248412085001/', Decimal('0.1363636364'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [3, 13, 'John Daly talks voter ID laws, predicts Tiger Woods comeback', 'https://video.foxnews.com/v/6248396045001/', Decimal('0E-10'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [3, 14, 'Rep. McCaul: Biggest border crisis I’ve seen in my lifetime', 'https://video.foxnews.com/v/6248386083001/', Decimal('0E-10'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [3, 15, 'Eric Shawn: ‘Court packing’ could be back at the Supreme Court', 'https://video.foxnews.com/v/6248377827001/', Decimal('0E-10'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [3, 16, "Hundreds of counter-protesters clash with 'White Lives Matter' rally-goers in California, 12 arrested", 'https://www.foxnews.com/us/white-lives-matter-rally-california-12-arrests', Decimal('0E-10'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [3, 17, "Marines' vaccine hesitancy presents early test for Biden as commander-in-chief", 'https://www.foxnews.com/politics/marines-vaccine-coronavirus-biden-democrats-military', Decimal('0.1000000000'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [3, 18, "Yale law school prof denies allegations of hosting inappropriate dinner parties, slams student newspaper report as 'hit job'", 'https://www.foxnews.com/us/tiger-mom-amy-chua-denies-parties-yale', Decimal('0E-10'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [3, 19, 'Fox News obtains exclusive details on how Iranians are punished for mere contact with Israelis', 'https://www.foxnews.com/world/iran-tehran-jail-pro-israel-ties', Decimal('-0.5000000000'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [3, 20, 'Top CEOs consider stopping political donations to oppose voting bills', 'https://www.foxbusiness.com/politics/ceos-plan-new-push-on-voting-legislation', Decimal('0.2500000000'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [3, 21, 'MSNBC host lets Dem rep go off the rails with misleading information about guns', 'https://www.foxnews.com/media/msnbc-host-house-dem-guns-dylann-roof', Decimal('0E-10'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [3, 22, "Texas senator questions who's 'really in charge'", 'https://www.foxnews.com/politics/cornyn-questions-biden-in-charge', Decimal('0.2000000000'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [3, 23, "'Squad' member manages to tie 'cancel student debt' fight with racism", 'https://www.foxnews.com/politics/cancel-student-debt-anti-racist-ayanna-pressley', Decimal('0E-10'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [3, 24, 'Prince Harry quarantining at his and Meghan Markle’s Frogmore Cottage ahead of Prince Philip’s funeral: report', 'https://www.foxnews.com/entertainment/prince-harry-quarantining-meghan-markle-frogmore-cottage-prince-philip-funeral', Decimal('0E-10'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)], [3, 25, "Harvey Weinstein fighting extradition to Los Angeles; lawyer says he's almost blind and missing teeth", 'https://www.foxnews.com/entertainment/harvey-weinstein-fighting-extradiction-los-angeles-blind-missing-teeth', Decimal('-0.3500000000'), datetime.datetime(2021, 4, 12, 17, 30, 30, 633169)]]
...
for i in nytimeslist:
    nytimes = Headline(headline=i[2], newspaper=i[0],link=i[3], day_order=i[1], sentiment=i[4], date=i[5])
    nytimes.save()

for i in fnlist:
    foxnews = Headline(headline=str(i[2]), newspaper=i[0],link=i[3], day_order=i[1], sentiment=i[4], date=i[5])
    foxnews.save()

for i in bbclist:
    bbc = Headline(headline=i[2], newspaper=i[0],link=i[3], day_order=i[1], sentiment=i[4], date=i[5])
    bbc.save()


#date format is 2020-04-10
...
import textstat
for i in nytimeslist:
    nytimes_rl = Headlinewrl(headline=i[2], newspaper=i[0],link=i[3], day_order=i[1], sentiment=i[4], reading_level=textstat.text_standard(i[2], float_output=True), date=i[5])
    nytimes_rl.save()

for i in fnlist:
    foxnews_rl = Headlinewrl(headline=str(i[2]), newspaper=i[0],link=i[3], day_order=i[1], sentiment=i[4], reading_level=textstat.text_standard(str(i[2]), float_output=True), date=i[5] )
    foxnews_rl.save()

for i in bbclist:
    bbc_rl = Headlinewrl(headline=i[2], newspaper=i[0],link=i[3], day_order=i[1], sentiment=i[4], reading_level=textstat.text_standard(i[2], float_output=True), date=i[5] )
    bbc_rl.save()
...
import textstat
for i in nytimeslist:
    nytimes_wc = Headlinewc(headline=i[2], newspaper=i[0],link=i[3], day_order=i[1], sentiment=i[4], reading_level=textstat.text_standard(i[2], float_output=True), headline_wc=len(i[2].split()), date=i[5])
    nytimes_wc.save()

for i in fnlist:
    foxnews_wc = Headlinewc(headline=str(i[2]), newspaper=i[0],link=i[3], day_order=i[1], sentiment=i[4], reading_level=textstat.text_standard(str(i[2]), float_output=True), headline_wc=len(str(i[2]).split()), date=i[5] )
    foxnews_wc.save()

for i in bbclist:
    bbc_wc = Headlinewc(headline=i[2], newspaper=i[0],link=i[3], day_order=i[1], sentiment=i[4], reading_level=textstat.text_standard(i[2], float_output=True), headline_wc=len(i[2].split()) , date=i[5])
    bbc_wc.save()
...
for i in nyt_best_words:
  save_to_db = superlative_table(graphid=1, newspaper=1, word=i[0], count=i[1], sentiment=i[2], date=today)
  save_to_db.save()

for i in bbc_best_words:
  save_to_db = superlative_table(graphid=1, newspaper=2, word=i[0], count=i[1], sentiment=i[2], date=today)
  save_to_db.save()

for i in fn_best_words:
  save_to_db = superlative_table(graphid=1, newspaper=3, word=i[0], count=i[1], sentiment=i[2], date=today)
  save_to_db.save()

for i in nyt_worst_words:
  save_to_db = superlative_table(graphid=2, newspaper=1, word=i[0], count=i[1], sentiment=i[2], date=today)
  save_to_db.save()

for i in bbc_worst_words:
  save_to_db = superlative_table(graphid=2, newspaper=2, word=i[0], count=i[1], sentiment=i[2], date=today)
  save_to_db.save()

for i in fn_worst_words:
  save_to_db = superlative_table(graphid=2, newspaper=3, word=i[0], count=i[1], sentiment=i[2], date=today)
  save_to_db.save()
...
for i in nyt_best_people:
  save_to_db = superlative_table(graphid=3, newspaper=1, word=i[0], count=i[1], sentiment=i[2], date=today)
  save_to_db.save()

for i in bbc_best_people:
  save_to_db = superlative_table(graphid=3, newspaper=2, word=i[0], count=i[1], sentiment=i[2], date=today)
  save_to_db.save()

for i in fn_best_people:
  save_to_db = superlative_table(graphid=3, newspaper=3, word=i[0], count=i[1], sentiment=i[2], date=today)
  save_to_db.save()
...
for i in nyt_best_places:
  save_to_db = superlative_table(graphid=4, newspaper=1, word=i[0], count=i[1], sentiment=i[2], date=today)
  save_to_db.save()

for i in bbc_best_places:
  save_to_db = superlative_table(graphid=4, newspaper=2, word=i[0], count=i[1], sentiment=i[2], date=today)
  save_to_db.save()

for i in fn_best_places:
  save_to_db = superlative_table(graphid=4, newspaper=3, word=i[0], count=i[1], sentiment=i[2], date=today)
  save_to_db.save()
...
for i in nyt_politics_words:
  save_to_db = superlative_table(graphid=5, newspaper=1, word=i[0], count=i[1], sentiment=i[2], date=today)
  save_to_db.save()

for i in bbc_politics_words:
  save_to_db = superlative_table(graphid=5, newspaper=2, word=i[0], count=i[1], sentiment=i[2], date=today)
  save_to_db.save()

for i in fn_politics_words:
  save_to_db = superlative_table(graphid=5, newspaper=3, word=i[0], count=i[1], sentiment=i[2], date=today)
  save_to_db.save()
...
for i in nyt_economic_words:
  save_to_db = superlative_table(graphid=6, newspaper=1, word=i[0], count=i[1], sentiment=i[2], date=today)
  save_to_db.save()

for i in bbc_economic_words:
  save_to_db = superlative_table(graphid=6, newspaper=2, word=i[0], count=i[1], sentiment=i[2], date=today)
  save_to_db.save()

for i in fn_economic_words:
  save_to_db = superlative_table(graphid=6, newspaper=3, word=i[0], count=i[1], sentiment=i[2], date=today)
  save_to_db.save()
...
for i in nyt_corona_words:
  save_to_db = superlative_table(graphid=7, newspaper=1, word=i[0], count=i[1], sentiment=i[2], date=today)
  save_to_db.save()

for i in bbc_corona_words:
  save_to_db = superlative_table(graphid=7, newspaper=2, word=i[0], count=i[1], sentiment=i[2], date=today)
  save_to_db.save()

for i in fn_corona_words:
  save_to_db = superlative_table(graphid=7, newspaper=3, word=i[0], count=i[1], sentiment=i[2], date=today)
  save_to_db.save()
...
for i in nyt_rp_words:
  save_to_db = superlative_table(graphid=8, newspaper=1, word=i[0], count=i[1], sentiment=i[2], date=today)
  save_to_db.save()

for i in bbc_rp_words:
  save_to_db = superlative_table(graphid=8, newspaper=2, word=i[0], count=i[1], sentiment=i[2], date=today)
  save_to_db.save()

for i in fn_rp_words:
  save_to_db = superlative_table(graphid=8, newspaper=3, word=i[0], count=i[1], sentiment=i[2], date=today)
  save_to_db.save()
...
for i in most_variance_words:
  save_to_db = variance_table_word(graphid=10, word = i[0], count = i[1], news1= i[2], news2 = i[3], sentiment = i[4], date=today)
  save_to_db.save()
...
for i in most_variance_people:
  save_to_db = variance_table_word(graphid=11, word = i[0], count = i[1], news1= i[2], news2 = i[3], sentiment = i[4], date=today)
  save_to_db.save()
...
for i in most_variance_places:
  save_to_db = variance_table_word(graphid=12, word = i[0], count = i[1], news1= i[2], news2 = i[3], sentiment = i[4], date=today)
  save_to_db.save()
...
for i in most_variance_politics:
  save_to_db = variance_table_word(graphid=13, word = i[0], count = i[1], news1= i[2], news2 = i[3], sentiment = i[4], date=today)
  save_to_db.save()
...
for i in most_variance_economics:
  save_to_db = variance_table_word(graphid=14, word = i[0], count = i[1], news1= i[2], news2 = i[3], sentiment = i[4], date=today)
  save_to_db.save()
...
for i in most_variance_corona:
  save_to_db = variance_table_word(graphid=15, word = i[0], count = i[1], news1= i[2], news2 = i[3], sentiment = i[4], date=today)
  save_to_db.save()
...
for i in most_variance_rp:
  save_to_db = variance_table_word(graphid=16, word = i[0], count = i[1], news1= i[2], news2 = i[3], sentiment = i[4], date=today)
  save_to_db.save()
...
for i in most_variance_dates:
  save_to_db = variance_table(graphid=9, variance_date=i[0], news1=i[1], news2=i[2], sentiment=i[3], date=today)
  save_to_db.save()
...
def save_to_super_sentiment_newspaper_overall_top_worst_20():
  ...
  for i in worst_overall:
    save_to_db = superlative_table(graphid=20, newspaper=4, word=i[0], count=i[1], sentiment=i[2], date=today)
    save_to_db.save()

  for i in top_overall:
    save_to_db = superlative_table(graphid=21, newspaper=4, word=i[0], count=i[1], sentiment=i[2], date=today)
    save_to_db.save()

  for i in worst_overall_nyt:
    save_to_db = superlative_table(graphid=20, newspaper=1, word=i[0], count=i[1], sentiment=i[2], date=today)
    save_to_db.save()

  for i in worst_overall_bbc:
    save_to_db = superlative_table(graphid=20, newspaper=2, word=i[0], count=i[1], sentiment=i[2], date=today)
    save_to_db.save()

  for i in worst_overall_fn:
    save_to_db = superlative_table(graphid=20, newspaper=3, word=i[0], count=i[1], sentiment=i[2], date=today)
    save_to_db.save()


  for i in top_overall_nyt:
    save_to_db = superlative_table(graphid=21, newspaper=1, word=i[0], count=i[1], sentiment=i[2], date=today)
    save_to_db.save()

  for i in top_overall_bbc:
    save_to_db = superlative_table(graphid=21, newspaper=2, word=i[0], count=i[1], sentiment=i[2], date=today)
    save_to_db.save()

  for i in top_overall_fn:
    save_to_db = superlative_table(graphid=21, newspaper=3, word=i[0], count=i[1], sentiment=i[2], date=today)
    save_to_db.save()
...
def get_superlatives_by_cat_in_database(graph_id_number,one, two, three, four, five, six):
  ...
  for i in get_best_nyt:
    save_to_db = superlative_table(graphid=graph_id_number, newspaper=1, word=i[0], count=i[1], sentiment=i[2], date=today)
    save_to_db.save()

  for i in get_best_bbc:
    save_to_db = superlative_table(graphid=graph_id_number, newspaper=2, word=i[0], count=i[1], sentiment=i[2], date=today)
    save_to_db.save()

  for i in get_best_fn:
    save_to_db = superlative_table(graphid=graph_id_number, newspaper=3, word=i[0], count=i[1], sentiment=i[2], date=today)
    save_to_db.save()

  for i in best_people:
    save_to_db = superlative_table(graphid=graph_id_number, newspaper=4, word=i[0], count=i[1], sentiment=i[2], date=today)
    save_to_db.save()
...
for i in coocs:
  for y in i:
      cooc_save_to_db = cooc(base_word=y[0], co_word=y[1], newspaper=y[2], co_word_count=y[3], date=today)
...
for i in nyt_most:
    save_to_db_wc = word_count_general(newspaper=1, word=i[0], word_count=i[1], date=today)
    save_to_db_wc.save()

for i in bbc_most:
    save_to_db_wc = word_count_general(newspaper=2, word=i[0], word_count=i[1], date=today)
    save_to_db_wc.save()

for i in fn_most:
    save_to_db_wc = word_count_general(newspaper=3, word=i[0], word_count=i[1], date=today)
    save_to_db_wc.save()

for i in overall_most:
    save_to_db_wc = word_count_general(newspaper=4, word=i[0], word_count=i[1], date=today)
    save_to_db_wc.save()
...
nyt_style_save_to_db = style_wc(newspaper=1,awc=avg_wc_nyt, ahrl=avg_rl_nyt, percent_quest=question_percent_nyt, percent_exclam=exclamation_percent_nyt, ahwl=nyt_avg_word_length, uw=nyt_unique_words, wd=nyt_top_50, date=today)
nyt_style_save_to_db.save()

bbc_style_save_to_db = style_wc(newspaper=2,awc=avg_wc_bbc, ahrl=avg_rl_bbc, percent_quest=question_percent_bbc, percent_exclam=exclamation_percent_bbc, ahwl=bbc_avg_word_length, uw=bbc_unique_words, wd=bbc_top_50, date=today)
bbc_style_save_to_db.save()

fn_style_save_to_db = style_wc(newspaper=3,awc=avg_wc_fn, ahrl=avg_rl_fn, percent_quest=question_percent_fn, percent_exclam=exclamation_percent_fn, ahwl=fn_avg_word_length, uw=fn_unique_words, wd=fn_top_50, date=today)
fn_style_save_to_db.save()

overall_style_save_to_db = style_wc(newspaper=4,awc=avg_wc_overall, ahrl=avg_rl_overall, percent_quest=question_percent_overall, percent_exclam=exclamation_percent_overall, ahwl=all_avg_word_length, uw=all_unique_words, wd=overall_top_50, date=today)
...
for term in nyt_cooc_dict:
    for cooc_list in nyt_cooc_dict[term]:
        cooc_save_to_db = cooc_wc(newspaper=1,base_word=term,cooc=cooc_list[0],coocc=cooc_list[1], date=today)
        cooc_save_to_db.save()

for term in bbc_cooc_dict:
    for cooc_list in bbc_cooc_dict[term]:
        cooc_save_to_db = cooc_wc(newspaper=2,base_word=term,cooc=cooc_list[0],coocc=cooc_list[1], date=today)
        cooc_save_to_db.save()

for term in fn_cooc_dict:
    for cooc_list in fn_cooc_dict[term]:
        cooc_save_to_db = cooc_wc(newspaper=3,base_word=term,cooc=cooc_list[0],coocc=cooc_list[1], date=today)
        cooc_save_to_db.save()

for term in overall_cooc_dict:
    for cooc_list in overall_cooc_dict[term]:
        cooc_save_to_db = cooc_wc(newspaper=4,base_word=term,cooc=cooc_list[0],coocc=cooc_list[1], date=today)
        cooc_save_to_db.save()
